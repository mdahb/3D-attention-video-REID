...
class Mars(object):
    ...
    """
    root = '/media/nas-570-002-nfssamba/amran/dataset/MARS'
...
class DukeMTMCVidReID(object):
    ...
    def __init__(self, root='/media/nas-570-002-nfssamba/amran/dataset', min_seq_len=0, verbose=True, **kwargs):
...
class iLIDSVID(object):
    ...
    """
    root ='/media/nas-570-002-nfssamba/amran/dataset'
    ...
    def _prepare_split(self):
        if not osp.exists(self.split_path):
            ...
            for i_split in range(num_splits):
               ...
               # pdb.set_trace()
                train_idxs = sorted(list(mat_split_data[int(i_split),int(num_ids_each):]))
                test_idxs = sorted(list(mat_split_data[int(i_split),:int(num_ids_each)]))
